...
public class Persistent {
  public static final long testMap() {
    ...
    final io.lacuna.bifurcan.Map<String, Long> c =
        new io.lacuna.bifurcan.Map<String, Long>()
            .put(":x", 11L, io.lacuna.bifurcan.Maps.MERGE_LAST_WRITE_WINS)
            .put(":y", 13L, io.lacuna.bifurcan.Maps.MERGE_LAST_WRITE_WINS);
    final io.lacuna.bifurcan.Map<Object, Object> d =
            ...
            .put(":y", 13L, io.lacuna.bifurcan.Maps.MERGE_LAST_WRITE_WINS);
    {
      ...
      {
        final Object anyY = ":y";
        final io.lacuna.bifurcan.Map<Object, Object> eMap =
            (io.lacuna.bifurcan.Map<Object, Object>) e;
  ...
  public static final long testVector() {
    ...
    final io.lacuna.bifurcan.List<Long> c =
        new io.lacuna.bifurcan.List<Long>().addLast(11L).addLast(13L);
    final io.lacuna.bifurcan.List<Object> d =
        new io.lacuna.bifurcan.List<Object>().addLast(11L).addLast(13L);
    {
  ...
  public static final long testSet() {
    ...
    final io.lacuna.bifurcan.Set<Long> c =
        new io.lacuna.bifurcan.Set<Long>().add(11L).add(13L).add(15L);
    final io.lacuna.bifurcan.Set<Object> d =
        new io.lacuna.bifurcan.Set<Object>().add(11L).add(13L).add(15L);
    {
  ...
  public static final long testConj() {
    final io.lacuna.bifurcan.Map<String, Long> a =
        new io.lacuna.bifurcan.Map<String, Long>()
            .put(":a", 1L, io.lacuna.bifurcan.Maps.MERGE_LAST_WRITE_WINS);
    final io.lacuna.bifurcan.Map<String, Long> b =
        new io.lacuna.bifurcan.Map<String, Long>()
            .put(":b", 2L, io.lacuna.bifurcan.Maps.MERGE_LAST_WRITE_WINS);
    final io.lacuna.bifurcan.Map<String, Long> c = a.union(b);
    {
      System.out.println(("" + "size of conj persistent map c returns " + c.size()));
      return 11L;
    }
  }
