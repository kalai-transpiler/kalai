...
(deftest demo02-logic
  ...
  (testing "format"
    (expect "50301" (format 50301 "LATIN" "OFF"))
    (expect "321" (format 321 "LATIN" "OFF"))
    (expect "21" (format 21 "LATIN" "OFF"))
    (expect "1" (format 1 "LATIN" "OFF"))
    (expect "\u0665\u0660\u0663\u0660\u0661" (format 50301 "ARABIC" "OFF"))
    (expect "\u0663\u0662\u0661" (format 321 "ARABIC" "OFF"))
    (expect "\u0662\u0661" (format 21 "ARABIC" "OFF"))
    (expect "\u0661" (format 1 "ARABIC" "OFF"))
    (expect "৫০৩০১" (format 50301 "BENGALI" "OFF"))
    (expect "৩২১" (format 321 "BENGALI" "OFF"))
    (expect "২১" (format 21 "BENGALI" "OFF"))
    (expect "১" (format 1 "BENGALI" "OFF"))))
