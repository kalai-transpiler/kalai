...
final Object op = clojure.Core.first(v);
final Object more = clojure.Core.next(v);
return ("" + "(" + String.join(("" + " " + op + " "), more.stream().map(sqlbuilder.Core::whereStr).collect(Collectors.toList())) + ")");
}
else
{
