...
final Object e = new io.lacuna.bifurcan.Map<Object,Object>().put(":x", 11L, io.lacuna.bifurcan.Maps.MERGE_LAST_WRITE_WINS).put(":y", 13L, io.lacuna.bifurcan.Maps.MERGE_LAST_WRITE_WINS);
{
...
final io.lacuna.bifurcan.Map<String,Long> a = new io.lacuna.bifurcan.Map<String,Long>().put(":a", 1L, io.lacuna.bifurcan.Maps.MERGE_LAST_WRITE_WINS);
final io.lacuna.bifurcan.Map<String,Long> b = new io.lacuna.bifurcan.Map<String,Long>().put(":b", 2L, io.lacuna.bifurcan.Maps.MERGE_LAST_WRITE_WINS);
